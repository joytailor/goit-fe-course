...
class Hamburger {
   ...
   */
  addTopping = (topping) => {if(this._toppings.filter(top => top !== topping)){this._toppings.push(topping)}};

  /**
   * Убрать topping, при условии, что она ранее была добавлена
   * @param {String} topping - Тип добавки
   */
  removeTopping = (topping) => {this.toppings.pop(topping)};
   ...
   */
  getStuffing() {return this._stuffing};
   ...
   */
  calculatePrice() {return this._price};
   ...
   */
  calculateCalories() {return this._calories};
