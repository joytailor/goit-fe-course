...
function createFullview(galleryItems){
  ...
  fullviewImage.style.width = "1280px";
  fullviewImage.style.height = "auto";
  fullviewImage.src = 'img/fullview-1.jpeg';
  fullviewItem.append(fullviewImage);
  return gallery.append(fullviewItem);
}

function createPreview (galleryItems){
  const list = document.createElement('ul');
  list.classList.add('preview');
  galleryItems.map(function(el) {
    const previewItem = document.createElement('li');
    const previewImage = document.createElement('img');
    previewItem.append(previewImage);
    previewImage.src = el.preview;
    previewImage.style.width = "100%";
    previewImage.style.height = "auto";
    previewImage.dataset = el.fullview;
    previewImage.alt = el.alt;
    list.append(previewItem);
    return list.append(previewItem);
  })
